...
@Getter
@NoArgsConstructor
public class ChkSaveRequestDto {
    private Long id;
    ...
    @Builder
    public ChkSaveRequestDto(Long id, String arrDt, String depDt, Integer nightCnt, String roomTypCd, Integer adultCnt, Integer chldCnt,
